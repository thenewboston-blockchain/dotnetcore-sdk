    ...
    public class TransactionsServiceTests
    {
        public class GetAllTransactionsAsync
        {
            ...
            public async void ListOfTransactionsIsReturned()
            {
                ...
                Assert.Equal("2484fbf3-2054-48a4-a1ce-66333cd15470", transactions.Results.ElementAt(0).Id);
            }
        }
        ...
        internal static TransactionsService BuildBankTransactionMock()
        {
            ...
            var listResult = new PaginatedResponseModel<BankTransaction>() {
                Count = 2,
                Next = string.Empty,
                Previous = String.Empty,
                Results = new List<BankTransaction>() {
                    new BankTransaction {
                        ...
                        Block = new BankBlock {
                            ...
                            Signature =
                                "c4a7696abc0f1e760a0c87d2a8db1faec060f99a77bf5f669a69dfdb301150db8fdaa2863a5d4a4e75be626ff56aecdbfea034283b1eb5a8e0196fd35f541b0b"
                        },
                        Amount = 1,
